...
function Button({ disabled, ...props }) {
    return ((0, jsx_runtime_1.jsx)("button", { className: classNames('Button', 'color-neutral', 'variant-solid', 'size-small', 'spacing-default'), disabled: disabled, "aria-disabled": disabled, ...props }));
}
