...
const Input_css_1 = __importDefault(require("./Input.css"));
const Button_css_1 = __importDefault(require("./Button.css"));
const ButtonGroup_css_1 = __importDefault(require("./ButtonGroup.css"));
const classNames = bind_1.default.bind({ ...Input_css_1.default, ...Button_css_1.default, ...ButtonGroup_css_1.default });
